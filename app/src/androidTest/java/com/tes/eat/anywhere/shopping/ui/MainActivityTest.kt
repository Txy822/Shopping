...
class MainActivityTest {
    ...
    fun mainActivityTest() {
        ...
        textInputEditText3.perform(replaceText("2.2"), closeSoftKeyboard())
        ...
        textInputEditText4.perform(replaceText("Orange"), closeSoftKeyboard())
        ...
        textInputEditText6.perform(replaceText("1.0"), closeSoftKeyboard())
